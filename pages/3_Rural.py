...
agg_road_class = prep_agg_data(df_crashes_rural, ['FUNC_CLS', 'ROAD_CLASS_DESC'], 'count')
...
st.title("🌽 Rural Crash Data")
st.caption("Detailed data on crashes in rural areas.")
...
col1.metric("Total Rural Crashes", f"{total_crashes:,}")  # https://docs.streamlit.io/develop/api-reference/data/st.metric
col2.metric("Avg Rural Crash Rate in 3 Mile Segment", f"{avg_crash_rate:.2f}")
col3.metric(
